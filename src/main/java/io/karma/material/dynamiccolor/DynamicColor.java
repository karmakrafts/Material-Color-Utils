...
import io.karma.material.contrast.Contrast;
 ...
 *
 * <p>This color automatically adjusts to accommodate a desired io.karma.material.contrast level, or other adjustments
 * such as differing in light mode versus dark mode, or what the theme is, or what the color that
 * produced the theme is, etc.
 *
 * <p>Colors without backgrounds do not change tone when io.karma.material.contrast changes. Colors with backgrounds
 * become closer to their background as io.karma.material.contrast lowers, and further when io.karma.material.contrast increases.
 *
 ...
 * io.karma.material.contrast level, and ensuring it has a certain lightness/tone difference from another color, is
...
public final class DynamicColor {
   ...
   *
   * <p>For example, the default behavior of adjust tone at max io.karma.material.contrast to be at a 7.0 ratio with
   ...
   *     a tonal palette, when io.karma.material.contrast adjustments are made, intended chroma can be preserved.
   ...
   * @param contrastCurve A `ContrastCurve` object specifying how its io.karma.material.contrast against its
   *     background should behave in various io.karma.material.contrast levels options.
   ...
   *
   * <p>Result has no background; thus no support for increasing/decreasing io.karma.material.contrast for a11y.
   *
   * @param name The name of the dynamic color.
   ...
   *     dark mode or light mode, and what the desired io.karma.material.contrast level is.
   */
  ...
  public Hct getHct(@NotNull DynamicScheme scheme) {
    ...
    // and changing its tone for io.karma.material.contrast. Rather, we find the tone for io.karma.material.contrast, then
    // use the specified chroma from the palette to construct a new color.
    //
    // For example, this enables colors with standard tone of T90, which has limited chroma, to
    // "recover" intended chroma as io.karma.material.contrast increases.
  ...
  /** Returns the tone in HCT, ranging from 0 to 100, of the resolved color given io.karma.material.scheme. */
  public double getTone(@NotNull DynamicScheme scheme) {
    ...
    if (toneDeltaPair != null) {
      ...
      if (decreasingContrast) {
        // If decreasing io.karma.material.contrast, adjust color to the "bare minimum"
        // that satisfies io.karma.material.contrast.
      ...
      // Case 2: No io.karma.material.contrast pair; just solve for itself.
  ...
  /**
   * Given a background tone, find a foreground tone, while ensuring they reach a io.karma.material.contrast ratio
  ...
  public static double foregroundTone(double bgTone, double ratio) {
    ...
    if (preferLighter) {
      // "Neglible difference" handles an edge case where the initial io.karma.material.contrast ratio is high
      ...
      // high and max io.karma.material.contrast in light mode. PC's standard tone was T90, OPC's was T10, it was
      // light mode, and the io.karma.material.contrast level was 0.6568521221032331.
  ...
  /**
   * Adjust a tone down such that white has 4.5 io.karma.material.contrast, if the tone is reasonably close to
   * supporting it.
   */
   ...
   *
   * <p>Since `tertiaryContainer` in dark monochrome io.karma.material.scheme requires a tone of 60, it should not be
  ...
  /** Tones less than ~T50 always permit white at 4.5 io.karma.material.contrast. */
