...
/**
 * Provides important settings for creating colors dynamically, and 6 color io.karma.material.palettes. Requires: 1. A
 * color. (source color) 2. A theme. (Variant) 3. Whether or not its dark mode. 4. Contrast level.
 * (-1 to 1, currently io.karma.material.contrast ratio 3.0 and 7.0)
 */
