...
import io.karma.material.dislike.DislikeAnalyzer;
...
public final class MaterialDynamicColors {
   ...
   * they are, they can't be adjusted for io.karma.material.contrast.* For now, they will be set with no background,
   * and those won't adjust for io.karma.material.contrast, avoiding issues.
   *
   * <p>* For example, if the same color is on a white background _and_ black background, there's no
   * way to increase io.karma.material.contrast with either without losing io.karma.material.contrast with the other.
   */
