...
package io.karma.material.temperature;
...
/**
 * Design utilities using color io.karma.material.temperature theory.
 *
...
public final class TemperatureCache {
   ...
   *
   * <p>The colors are equidistant in io.karma.material.temperature and adjacent in hue.
   */
  ...
  /**
   * A set of colors with differing hues, equidistant in io.karma.material.temperature.
   *
  ...
  public List<Hct> getAnalogousColors(int count, int divisions) {
    ...
    while (allColors.size() < divisions) {
      ...
      int indexAddend = 1;
      // Keep adding this hue to the answers until its io.karma.material.temperature is
      // insufficient. This ensures consistent behavior when there aren't
      // `divisions` discrete steps between 0 and 360 in hue with `tempStep`
      // delta in io.karma.material.temperature between them.
      //
   ...
   *
   * @param hct HCT to find the relative io.karma.material.temperature of.
  ...
  public double getRelativeTemperature(Hct hct) {
    ...
    // Handle when there's no difference in io.karma.material.temperature between warmest and
  ...
  /** Keys of HCTs in getHctsByTemp, values of raw io.karma.material.temperature. */
